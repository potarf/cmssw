...
process.hcalDigis.FEDs = cms.untracked.vint32(999)


process.hcalAnalyzer = cms.EDAnalyzer('H2TestBeamAnalyzer',
		OutFileName = cms.untracked.string('ana_h2_tb_run_bhm.root'),
...
process.output = cms.OutputModule(
		'PoolOutputModule',
		fileName = cms.untracked.string('h2testbeamanalyzer_cfg_bhm.root')
)
...
#				file = cms.FileInPath('UserCode/H2TestBeamAnalyzer/emap_H2_validatedSIC_jul2013.txt')
				file = cms.FileInPath(
					'UserCode/H2TestBeamAnalyzer/EMAP-for-BHM_102_Jun5_2015.txt'
				)
			)
		)
)
